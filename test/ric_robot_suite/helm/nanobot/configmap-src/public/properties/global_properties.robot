...
${GLOBAL_TOTAL_NODEB_E2SIM1}          {{ .Values.ric.robot.environment.gNodeB.total_gNodeB_e2sim_1 }}
${GLOBAL_TOTAL_NODEB_E2SIM2}          {{ .Values.ric.robot.environment.gNodeB.total_gNodeB_e2sim_2 }}
${GLOBAL_TERMINAL_IP}                  {{ .Values.ric.robot.environment.gNodeB.cluster_ip }}
${GLOBAL_USER_NAME}                    {{ .Values.ric.robot.environment.gNodeB.username }}
${GLOBAL_USER_PWD}                    {{ .Values.ric.robot.environment.gNodeB.password }}
#
...
${GLOBAL_KPIMON_DEPLOYMENT}           {{ printf "%s-%s" ($xappNS) .Values.ric.robot.environment.kpimon }}
...
${Global_VIAVI_DEPLOYMENT}            {{ .Values.ric.robot.environment.gNodeB.viavi_deployment }}
${Global_RAN_DEPLOYMENT}              {{ .Values.ric.robot.environment.gNodeB.ran_deployment }}
${Global_RAN_DEPLOYMENT_1}            {{ .Values.ric.robot.environment.gNodeB.ran_deployment_1 }}
${Global_RAN_DEPLOYMENT_2}            {{ .Values.ric.robot.environment.gNodeB.ran_deployment_2 }}
